...
export const WORKOUT_PLAN: WorkoutDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Outdoor Hike", sets: "1", reps: "2\u20134 hrs", current: "Hitchcock / local trails", goal: "3+ hrs w/ 15 lb pack", goalValue: 3, unit: "hrs", notes: "Best TMB-specific cardio. Hills > flat. Log hours and pack weight." },
